    ...
    <section className="py-[130px]">
      <Container>
        <div className="mx-auto w-full max-w-7xl">
          ...
          <ul className="mt-15 grid grid-cols-1 gap-5 xl:grid-cols-3">
            {cards.map((card) => (
              <li
                key={card.id}
                className="relative overflow-hidden rounded-[6px] border border-[#ED5F00]/40 bg-cover bg-bottom bg-no-repeat"
                style={{ backgroundImage: "url('/images/automation-bg.png')" }}
              >
                <div className="relative z-10 flex min-h-[520px] flex-col justify-between p-4">
                  ...
                  <div className="mt-6 max-w-[236px]">
                    <Image
                      src="/row.svg"
                      alt=""
                      width={24}
