...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative max-w-7xl py-10 max-w-7xl xl:pt-48 xl:pb-24">
        <div className="grid grid-cols-1 items-center gap-9 lg:grid-cols-[0.9fr_1.1fr] xl:grid-cols-[547px_minmax(0,695px)] xl:justify-between">
          ...
          <div className="flex flex-col max-w-full gap-5 xl:max-w-[547px]">
            <h1 className="font-heading text-[52px] leading-[58px] font-bold tracking-[-0.03em] text-foreground xl:text-[64px] xl:leading-[72px]">
                <span className="text-white [text-shadow:0_0_80px_#ED5F00,0_0_20px_rgba(237,95,0,0.12),0_0_40px_#ED5F00,0_0_20px_#FE02F0,0_0_10px_#FE02F0]">Automate</span> Your Business with Next-Level AI
          </h1> 

            <p className="text-primary-50 text-body-md font-regular leading-normal xl:text-body-lg  xl:leading-[28px] xl:max-w-[513px]">
